...
$fetch_user_table = mysqli_query($connection, "SELECT * FROM suggestion_tbl");
if(!$fetch_user_table)
  ...
  <body class="sb-nav-fixed">
      ...
      <div id="layoutSidenav_content">
        <main>
          <div class="container-fluid px-4">
            <h1 class="mt-4">Suggestion Table</h1>
                ...
                <table class="table table-bordered">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><a href="./del_suggestion.php?id=<?php echo $row['id'] ?>" class="text-danger" id="confirmDelete"><i class="fas fa-trash-alt"></i></a></td>
                    </tr>
                    <?php }?>
                  </tbody>
                </table>
    ...
    <script>
        ...
        del.addEventListener('click', e => {
            const conf = confirm('Delete this suggestion?');
